        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex justify-between items-center pb-8 border-b border-gray-100">
               <div>
                 <h2 className="text-xl font-bold text-gray-900 mb-1">Hosted by {property.owner.name}</h2>
                 <p className="text-gray-500 text-sm">Joined in 2021</p>
               </div>
               <img src={property.owner.image} alt={property.owner.name} className="w-14 h-14 rounded-full object-cover border border-gray-200" />
            </div>
            ...
            <div className="py-8 border-b border-gray-100">
               <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">King & Queen beds</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">En-suite available</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                    <Square className="h-6 w-6 text-indigo-600" />
                    <div>
                      <p className="font-bold text-gray-900">{property.sqft} sqft</p>
               ...
               <p className="text-gray-600 leading-relaxed">
                 Located in a quiet neighborhood, this property offers the perfect blend of comfort and style. 
                 Recently renovated with high-end finishes, it features an open concept living area, 
            ...
            <div className="py-8">
               ...
               <div className="bg-gray-100 rounded-xl h-[300px] w-full flex items-center justify-center text-gray-500 relative overflow-hidden group">
                  <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1524661135-423995f22d0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80')] bg-cover bg-center opacity-50 grayscale group-hover:grayscale-0 transition-all duration-500"></div>
